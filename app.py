...
def main():
    ...
    st.sidebar.write(
        "Depth is a measurement of how deep the diamond is, from the table (top) to the culet (bottom). It's expressed as a percentage of the diamond's overall width. Depth affects the diamond's brilliance and sparkle, with an ideal depth percentage providing optimal light reflection and refraction.")
    st.sidebar.write("TABLE:", table_emoji)
    st.sidebar.write(
        "Table of a diamond is the flat surface on the top of the diamond when you look at it from above. The size of this flat surface can affect how the diamond looks and shines.",
